...
This document records the official hardware evidence needed by P4 of the
[dedicated 3.49B TODO](WAVESHARE-ESP32-S3-TOUCH-LCD-3.49B-TODO.md). The 3.49B
name describes the Case B enclosure and battery option; it does not identify
the PCB revision.
...
Until those markings are confirmed, `dmd_panel_waveshare349b.c` must continue
to return `ESP_ERR_NOT_SUPPORTED` on physical hardware.
