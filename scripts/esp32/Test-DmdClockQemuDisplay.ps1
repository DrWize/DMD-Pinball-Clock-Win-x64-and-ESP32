...
Write-Host "[PASS] $Model QEMU display is ${width}x${height} and nonblank."
Write-Host "       Non-black pixels: $nonBlackPixels; bounds: x=$minimumX..$maximumX, y=$minimumY..$maximumY"
